        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            leading: FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('SIGN_IN_PAGE_angleLeft_ICN_ON_TAP');
                              ...
                              children: [
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 24.0, 0.0, 0.0),
                                  child: Text(
                                    'Войдите в своё волшебное пространство, введя вашу почту и  пароль.\n\nПредсказание на сегодня уже ждет Вас!',
                                ...
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'SIGN_IN_PAGE_Container_wd18o3vk_ON_TAP');
                                      logFirebaseEvent(
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 12.0, 0.0, 12.0),
                                          child: Text(
                                            'Знания о пароле утрачены! Нужна ваша помощь ...',
                                            style: FlutterFlowTheme.of(context)
                                                .bodySmall
                                                .override(
                                                  fontFamily: 'JOST',
                                  ...
                                  children: [
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 0.0, 0.0, 12.0),
                                      child: Text(
                                        'У вас еще нет доступа к знаниям бесконечности?',
                                        textAlign: TextAlign.center,
                                        style: FlutterFlowTheme.of(context)
                                            .labelLarge
                                            .override(
                                              fontFamily: 'JOST',
                                              color: Color(0xFFEBD6FB),
                                              letterSpacing: 0.0,
                                            ),
                                      ),
                                    ),
