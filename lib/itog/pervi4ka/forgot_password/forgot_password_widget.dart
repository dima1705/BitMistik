        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            leading: FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('FORGOT_PASSWORD_angleLeft_ICN_ON_TAP');
                            ...
                            children: [
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 24.0, 0.0, 24.0),
                                child: Text(
                                  'Вы утратили пароль? Не отчаивайтесь, мы рядом и поможем вам!',
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    1.0, 0.0, 0.0, 0.0),
                                            child: Text(
                                              'Просто укажите свою почту и получите ссылку для сброса пароля ♡',
                                              textAlign: TextAlign.start,
                                              style:
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'FORGOT_PASSWORD_Container_cdx4s8v7_ON_TA');
                                    logFirebaseEvent(
